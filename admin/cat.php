   ...
   <div class="card mb-4">
      <div class="card-body">
       ...
       <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        <div class="mb-3">
         <label for="c_name" class="form-label">Category Name</label><input type="text" class="form-control c_name" id="c_name"
         name="c_name" required>
      </div>

      <div class="mb-3">
         <label for="c_icon" class="form-label">Category Icon</label><input type="text" class="form-control c_icon" id="c_icon"
         name="c_icon" required>
      </div>
      <div class="mb-3">
         <button class="btn btn-success"
         type="submit" name="c_submit">Submit</button>
    ...
    <?php while ($final =   $s_sql -> fetch_assoc() ){?>
     <tr>
      ...
      <td> 
       ...
       <a href="cat_delete.php?id=<?php echo $final['id']; ?>">Delete</a>
