...
if (isset($_POST['c_update'])) {
   ...
   $update_sql="UPDATE `category` SET `name`='$name',`icon`='$icon' WHERE id=$cid";
...
<input value="<?php echo $final['id']; ?>" type="hidden" name="c_id" required>
        ...
        <div class="mb-3">
         <label for="c_name" class="form-label">Category Name</label><input value="<?php echo $final['name']; ?>" type="text" class="form-control c_name" id="c_name"
         name="c_name" required>
      </div>

      <div class="mb-3">
         <label for="c_icon" class="form-label">Category Icon</label><input value="<?php echo $final['icon']; ?>" type="text" class="form-control c_icon" id="c_icon"
         name="c_icon" required>
      </div>
      <div class="mb-3">
         <button class="btn btn-success"
         type="submit" name="c_update">Update</button>
